...
//       const active = res.data.filter(child => child.age > 10).length; // Compare directly with age
...
//       const income = totalRevenue * 0.8; // Example calculation for income
//       const expenses = totalRevenue * 0.2; // Example calculation for expenses
//       setFinanceData({ revenue: totalRevenue, income, expenses });
//     });

//     // Fetch attendance data (Updated to fetch present/absent data)
...
//       const enrollmentsByMonth = Array(12).fill(0); // Array for storing counts of enrollments per month

//       res.data.forEach(enrollment => {
//         const enrolledMonth = new Date(enrollment.enrolled_date).getMonth(); // Get the month (0-11)
//         enrollmentsByMonth[enrolledMonth] += 1; // Increment the count for the corresponding month
//       });
...
//   // Chart data for children
//   const childrenChartData = {
//     labels: ['Active', 'Inactive'],
//     datasets: [
//       {
//         label: 'Children',
//         data: [childrenData.active, childrenData.inactive],
//         backgroundColor: ['#36A2EB', '#FF6384'],
//       },
//     ],
//   };

//   // Chart data for caregivers
//   const caregiverChartData = {
//     labels: ['Active', 'Inactive'],
//     datasets: [
//       {
//         label: 'Caregivers',
//         data: [caregiverData.active, caregiverData.inactive],
//         backgroundColor: ['#36A2EB', '#FF6384'],
//       },
//     ],
//   };
...
//       {
//         label: 'Finance',
//         data: [financeData.revenue, financeData.income, financeData.expenses],
//         backgroundColor: ['#4BC0C0', '#36A2EB', '#FF6384'],
//       },
//     ],
//   };

//   // Chart data for attendance (Updated for Present and Absent)
...
//   // Chart data for enrollments (Now dynamic based on database data)
